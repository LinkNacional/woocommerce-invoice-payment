<div class="show_if_donation dokan_donation_settings">
	<p>
		<label for="_donation_type"><?php esc_html_e('Donation type', 'wc-invoice-payment'); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_attr_e(__('Select the donation type.', 'wc-invoice-payment')); ?>"></i></label>
	...
	<p class="show_if_donation_variable">
		<label for="_donation_button_values"><?php esc_html_e('Preset button values', 'wc-invoice-payment'); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_attr_e(__('Enter the preset button values separated by comma. E.g.: 10, 20, 25', 'wc-invoice-payment')); ?>"></i></label>
	...
	<p class="show_if_donation_free">
		<label for="_donation_free_text"><?php esc_html_e('Text', 'wc-invoice-payment'); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_attr_e(__('Text to be displayed for free donation.', 'wc-invoice-payment')); ?>"></i></label>
	...
	<div class="donation-deadline-section dokan-section">
		...
		<p class="show_if_donation_deadline">
			...
			?>
			<label for="_donation_deadline_date"><?php esc_html_e('Deadline date and time', 'wc-invoice-payment'); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_attr_e(__('Set the deadline date and time for donations.', 'wc-invoice-payment')); ?>"></i></label>
		...
		<p class="show_if_donation_deadline">
			<label for="_donation_deadline_message"><?php esc_html_e('Deadline expired message', 'wc-invoice-payment'); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_attr_e(__('Message to display when the donation deadline has passed.', 'wc-invoice-payment')); ?>"></i></label>
