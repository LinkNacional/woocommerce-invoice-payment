...
final class QRtools {
    ...
    public static function log($outfile, $err) {
        ...
        if (QR_LOG_DIR !== false && '' !== $err) {
            $log_file_path = QR_LOG_DIR . (false !== $outfile ? basename($outfile) . '-errors.txt' : 'errors.txt');
