...
= 2.9.0 = *12/29/2025*
* Add OTP for user registration and login.

= 2.8.1 = *12/22/2025*
* Fix for errors found by wordfence.
* Fix in partial payments creation script.
...
= 2.7.1 = *11/12/2025*
* CSS loading fix;
* Add of read-only on selected product in the invoice.
